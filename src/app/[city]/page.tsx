...
const services = [
  {
    ...
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2zm0 7h14M9 3v7" />
    ),
  },
  {
    name: 'Washer Repair',
    ...
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8a4 4 0 100 8 4 4 0 000-8zM3 12h1m8-9v1m8 8h1m-9 8v1M5.6 5.6l.7.7m12.1-.7l-.7.7m.7 11.4l-.7-.7M6.3 18.4l-.7-.7" />
    ),
  },
  {
    name: 'Dryer Repair',
    ...
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 3v1m0 16v1M4.22 4.22l.71.71m14.14-.71l-.71.71M3 12h1m16 0h1M4.93 19.78l.71-.71m12.72.71l-.71-.71M12 8a4 4 0 100 8 4 4 0 000-8z" />
    ),
  },
  {
    ...
    icon: (
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2h-4M9 3a2 2 0 002 2h2a2 2 0 002-2M9 3a2 2 0 012-2h2a2 2 0 012 2" />
    ),
  },
  {
      ...
      <section className="bg-white pt-20 border-b border-slate-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
          ...
          <p className="text-lg text-slate-500 leading-relaxed mb-10 max-w-2xl">
            Same-day appliance repair for {city.name} homeowners. Our licensed technicians service all major brands — refrigerators, washers, dryers, dishwashers, ovens, and more. We carry OEM parts and back every repair with a 90-day warranty.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-10">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 border-2 border-blue-950 hover:bg-blue-950 hover:text-white text-blue-950 font-bold px-8 py-4 rounded-xl text-base transition-colors duration-200"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-3 text-sm text-slate-500">
            {['Licensed & Insured', 'Same-day available', '90-day warranty', 'OEM parts', 'Background-checked techs'].map((item) => (
      ...
      <section className="py-16 lg:py-20 bg-blue-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {services.map((svc) => (
              <div key={svc.name} className="bg-white rounded-2xl p-6 border border-blue-100 shadow-sm">
                <div className="w-10 h-10 bg-blue-950 rounded-xl flex items-center justify-center mb-4">
                  <svg className="w-5 h-5 text-[#ffb81c]" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    {svc.icon}
                  </svg>
                </div>
            ...
            {[
              ...
              <div key={item.title} className="flex gap-4">
                <div className="w-8 h-8 bg-[#ffb81c] rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                  <svg className="w-4 h-4 text-gray-900" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                </div>
                <div>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {nearbyCities.map((c) => (
                <Link
                  key={c.slug}
                  href={`/${c.slug}`}
                  className="px-4 py-2 bg-white border border-blue-200 hover:border-blue-500 hover:text-blue-700 text-slate-600 text-sm font-medium rounded-full transition-colors duration-200"
                >
                  {c.name}
                </Link>
              ))}
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {faqs.map((faq) => (
              <div key={faq.q} className="bg-blue-50 rounded-2xl p-6">
      ...
      <section className="bg-blue-950 py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-200 mb-8 max-w-lg mx-auto">
            Same-day appointments available. Licensed technicians, 90-day warranty, OEM parts on every van.
          </p>
