    ...
    <>
      ...
      <main className="min-h-screen flex flex-col items-center justify-center bg-blue-50 pt-20 px-4">
        ...
        <div className="relative mb-8" aria-hidden="true">
          ...
          >
            {/* Appliance body */}
            <rect x="20" y="30" width="120" height="115" rx="10" fill="white" stroke="#1E3A8A" strokeWidth="3.5" />
            {/* Control panel top */}
            ...
            <path d="M62 99 Q68 93 74 99 Q80 105 86 99 Q92 93 98 99" stroke="#3B82F6" strokeWidth="2.5" strokeLinecap="round" fill="none" />
            <path d="M62 108 Q68 102 74 108 Q80 114 86 108 Q92 102 98 108" stroke="#3B82F6" strokeWidth="2.5" strokeLinecap="round" fill="none" />
            ...
            {/* Error X on door */}
            <line x1="72" y1="97" x2="88" y2="113" stroke="#EF4444" strokeWidth="2.5" strokeLinecap="round" opacity="0.5" />
            <line x1="88" y1="97" x2="72" y2="113" stroke="#EF4444" strokeWidth="2.5" strokeLinecap="round" opacity="0.5" />
            {/* Bottom feet */}
        ...
        <div className="text-center">
          <p
            ...
            style={{ fontFamily: "'Lexend', Arial, sans-serif", textShadow: '0 4px 24px rgba(255,184,28,0.18)' }}
            aria-label="Error 404"
          >
            404
          </p>

          <h1 className="mt-2 text-3xl sm:text-4xl font-bold text-blue-900" style={{ fontFamily: "'Lexend', Arial, sans-serif" }}>
            Page Not Found
          </h1>
          ...
          <p className="mt-8 text-sm text-slate-500">
            Need help?{' '}
            <a href="tel:+18005550123" className="text-blue-700 hover:text-blue-900 font-medium underline underline-offset-2 transition-colors duration-200">
              Call (800) 555-0123
            </a>
