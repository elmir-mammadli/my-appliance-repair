...
'@type':'ListItem',
 ...
 priority
 />
 <div className="absolute inset-0 bg-gradient-to-t from-blue-950/95 via-blue-950/55 to-blue-950/10" aria-hidden="true" />
 ...
 <span className={`inline-block text-xs font-bold uppercase tracking-wider px-3 py-1 mb-5 ${post.accentColor}`}>
 {post.category}
 </span>
