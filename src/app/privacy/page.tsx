      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ul className="list-disc list-outside pl-5 space-y-2 text-slate-600 mb-6">
            <li>
              <strong>Booking and Service Requests:</strong> When you submit a service request or
              booking form, we collect your name, phone number, email address, and service address.
            </li>
            <li>
              <strong>Contact Form:</strong> When you contact us through our website, we collect
              your name, email address, phone number, and the content of your message.
            </li>
            <li>
              <strong>Job Applications:</strong> When you apply for a position through our hiring
              form, we collect your name, email address, phone number, work experience, and any CV
              or resume file you choose to upload. Uploaded files are stored securely and used
              solely for employment consideration.
            </li>
          </ul>
          ...
          <ul className="list-disc list-outside pl-5 space-y-2 text-slate-600 mb-6">
            <li>
              ...
              our website, including your IP address, browser type, operating system, referring
              URLs, pages viewed, and the date and time of your visit.
            </li>
            <li>
              <strong>Cookies and Similar Technologies:</strong> We use cookies and similar tracking
              technologies to collect and store certain information. See Section 7 (Cookie Policy)
              for more details.
            </li>
          </ul>
          ...
          <ul className="list-disc list-outside pl-5 space-y-2 text-slate-600 mb-6">
            ...
            <li>
              To contact you regarding your appointment, service status, or follow-up questions.
            </li>
          ...
          <ul className="list-disc list-outside pl-5 space-y-2 text-slate-600 mb-6">
            ...
            <li>
              Limiting access to personal information to personnel who need it to perform their job
              functions.
            </li>
            <li>
              Using reputable third-party services with their own security practices for data
              storage and communications.
            </li>
          </ul>
          <p className="text-slate-600 leading-relaxed mb-6">
            No method of internet transmission or electronic storage is 100% secure. While we strive
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            ...
            in operating our business. These may include:
          </p>
          <ul className="list-disc list-outside pl-5 space-y-2 text-slate-600 mb-6">
            <li>
              <strong>Email Service Providers:</strong> We use third-party email platforms to send
              appointment confirmations, service updates, and communications.
            </li>
            <li>
              <strong>Payment Processors:</strong> If you pay online, your payment information is
              processed by a third-party payment processor. We do not store credit card or payment
              details on our servers.
            </li>
            <li>
              <strong>Analytics Providers:</strong> We may use analytics tools (such as Google
              Analytics) to understand how visitors use our website. These services may collect
              information about your use of the site using cookies and similar technologies.
            </li>
            <li>
              <strong>Cloud Storage and Form Processing:</strong> Submitted form data may be stored
              in third-party cloud platforms (such as Google Sheets or similar services) used for
              internal operations.
            </li>
          </ul>
          <p className="text-slate-600 leading-relaxed mb-6">
            These third parties are contractually obligated to handle your information in a manner
            consistent with this Privacy Policy and applicable law. We do not authorize them to use
            your personal information for their own independent purposes.
          </p>
          ...
          <ul className="list-disc list-outside pl-5 space-y-2 text-slate-600 mb-6">
            ...
            <li>
              ...
              subject to certain legal exceptions (e.g., information we are required to retain).
            </li>
            <li>
              <strong>Opt-Out of Marketing:</strong> If we send you marketing communications, you
              may opt out at any time by following the unsubscribe instructions in those emails or
              by contacting us.
            </li>
          </ul>
          <p className="text-slate-600 leading-relaxed mb-6">
          ...
          {/* Section 6 */}
          <h2 className="text-2xl font-bold text-blue-900 mb-4 mt-10">
            6. Connecticut Residents — CTDPA Rights
          </h2>
          <p className="text-slate-600 leading-relaxed mb-4">
            If you are a Connecticut resident, you have additional rights under the Connecticut Data
            Privacy Act (CTDPA), Conn. Gen. Stat. &sect; 42-515 et seq., effective January 1, 2023.
          ...
          <ul className="list-disc list-outside pl-5 space-y-2 text-slate-600 mb-6">
            ...
            <li>
              <strong>Right to Correct:</strong> You have the right to correct inaccuracies in your
              personal data.
            </li>
            <li>
            ...
            <li>
              <strong>Right to Opt Out:</strong> You have the right to opt out of the processing of
              personal data for purposes of targeted advertising or the sale of personal data. We do
              not sell personal data or use it for targeted advertising.
            </li>
            <li>
              <strong>Right to Appeal:</strong> If we decline to act on your rights request, you
              have the right to appeal that decision by contacting us.
            </li>
          </ul>
          <p className="text-slate-600 leading-relaxed mb-6">
          ...
          <ul className="list-disc list-outside pl-5 space-y-2 text-slate-600 mb-6">
            <li>
              <strong>Functional Cookies:</strong> These are necessary for the website to function
              properly. They enable core features such as page navigation and form submissions.
              These cookies do not collect personal information and cannot be disabled.
            </li>
            <li>
              <strong>Analytics Cookies:</strong> These cookies collect anonymous information about
              how visitors use our website, such as which pages are visited most often. This helps
              us improve the site experience. We may use services like Google Analytics for this
              purpose.
            </li>
          </ul>
          <p className="text-slate-600 leading-relaxed mb-6">
          ...
          <p className="text-slate-600 leading-relaxed mb-6">
            ...
            permitted by law. Service and booking records may be retained for up to five years for
            business and legal purposes. Job application data is retained for up to one year after
            the position is filled, after which it is securely deleted.
          </p>
          ...
          <p className="text-slate-600 leading-relaxed mb-6">
            ...
            privacy practices of those sites. We encourage you to review the privacy policies of any
          ...
          <p className="text-slate-600 leading-relaxed mb-6">
            ...
            or applicable law. When we do, we will revise the &ldquo;Last updated&rdquo; date at the
            top of this page. We encourage you to review this policy periodically to stay informed
