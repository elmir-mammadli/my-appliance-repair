        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-slate-500 leading-relaxed mb-8 max-w-2xl">
              Washers that won&apos;t spin. Fridges running warm. Ovens that won&apos;t hold temp.
              Pick an appliance below to see the symptoms we hear most weeks, the parts we keep on
              the truck, and book a repair. Same-day service when slots are open, anywhere from
              Greenwich to Mystic.
            </p>
            ...
            {/* Review pill */}
            <div className="inline-flex items-center gap-2 bg-white border border-blue-200 px-5 py-2 shadow-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Each card lists the symptoms we see most weeks, the parts on the truck, and the brands
              we work on.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-28 bg-blue-900" aria-labelledby="cta-heading">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <BookingButton className="inline-flex items-center justify-center gap-2 font-bold px-8 py-4 transition-all duration-200 cursor-pointer shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 text-gray-900 bg-[#ffb81c] hover:bg-[#e6a619]">
              <svg
                className="w-5 h-5"
                fill="none"
                viewBox="0 0 24 24"
