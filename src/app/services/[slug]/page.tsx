        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              No second visit when we can help it. These are the {service.shortName.toLowerCase()} parts most jobs need, and we carry them every day.
            </p>
          </div>

          <div className="bg-white rounded-2xl border border-blue-100 shadow-sm p-8">
            <p className="text-xs text-slate-400 mb-4 font-medium uppercase tracking-wider">On the van today:</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <div className="inline-flex items-center gap-2 mt-3 bg-white border border-blue-200 rounded-full px-5 py-2 shadow-sm">
              ...
              <span className="text-slate-500 text-sm">2,400+ verified reviews</span>
            </div>
          </div>
