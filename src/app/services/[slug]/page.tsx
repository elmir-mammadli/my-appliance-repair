...
export default async function ServicePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const processSteps = [
    {
      ...
      desc: 'Tell us what is broken. Two minutes, no account, no credit card.',
    },
    {
      step: '2',
      title: 'Tech shows up',
      desc: 'Same or next day. Parts already on the van for most jobs.',
    },
    {
      step: '3',
      title: 'Written estimate',
      desc: 'You see the cost before we open anything up. Diagnostic fee waived if you go ahead.',
    },
    {
      step: '4',
      title: 'Fix and warranty',
      desc: '90 days on parts and labor. If the same issue comes back, we come back.',
    },
  ];
  ...
  return (
    <main>
      ...
      {/* ── Hero ── */}
      <section
        className="bg-white pt-20 border-b border-slate-100"
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-blue-950 leading-[1.1] tracking-tight mb-6">
                {service.heroAccent !== service.title ? (
                  <>
                    <span className="text-[#ffb81c]">{service.heroAccent}</span> repair in
                    Connecticut
                  </>
                ) : (
                  <>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-5">
                <BookingButton
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-[#ffb81c] hover:bg-[#e6a619] text-gray-900 font-bold px-8 py-4 text-base transition-colors duration-200 cursor-pointer shadow-md"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
              ...
              <Link
                href="/#discounts"
                className="inline-flex items-center gap-2 bg-amber-50 hover:bg-amber-100 border border-amber-200 hover:border-amber-300 text-amber-800 text-sm font-semibold px-4 py-2 mb-8 transition-colors duration-200 self-start"
            ...
            <div className="relative overflow-hidden shadow-2xl shadow-slate-200 aspect-[4/5] bg-white border border-blue-100">
              <Image
          ...
          <div className="mt-12 grid sm:grid-cols-3 gap-4 text-center">
            {[
              ...
              {
                label: 'One trip when we can',
                sub: 'Parts stocked to finish most jobs the same day',
              },
            ].map((item) => (
              <div
                key={item.label}
                className="bg-white border border-blue-100 px-5 py-4 flex items-center gap-4 shadow-sm"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              These are the calls we get most weeks. If your {service.shortName.toLowerCase()} is
              doing any of them, we can almost always fix it on the first visit.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {service.symptoms.map((symptom) => (
              <div
                key={symptom}
                className="bg-white border border-blue-100 shadow-sm hover:shadow-lg transition-all duration-300 p-6 flex items-center gap-4"
              >
                <div className="w-10 h-10 bg-blue-700 flex items-center justify-center text-white flex-shrink-0 shadow-sm">
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 20 20"
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              Parts we keep in regular rotation, so most {service.shortName.toLowerCase()} jobs
              finish in one visit.
            </p>
          </div>

          <div className="bg-white border border-blue-100 shadow-sm p-8">
            ...
            <div className="flex flex-wrap gap-2">
              {service.parts.map((part) => (
                <span
                  key={part}
                  className="text-sm bg-blue-50 border border-blue-100 text-blue-700 px-3 py-1.5 font-medium"
                >
                  {part}
                </span>
              ))}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2">
            {service.brands.map((brand) => (
              <span
                key={brand}
                className="text-sm bg-white border border-slate-200 text-slate-600 px-4 py-2 font-medium shadow-sm"
              >
                {brand}
              </span>
            ))}
      ...
      <section className="py-20 lg:py-28 bg-white" aria-labelledby="process-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            {/* Review pill */}
            <div className="inline-flex items-center gap-2 mt-3 bg-white border border-blue-200 px-5 py-2 shadow-sm">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {processSteps.map((item) => (
              <div
                key={item.step}
                className="bg-white border border-blue-100 shadow-sm hover:shadow-lg transition-all duration-300 p-6"
              >
                <div className="w-8 h-8 bg-blue-700 text-white flex items-center justify-center text-sm font-bold mb-4">
                  {item.step}
                </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {related.map((r) => (
              <Link
                ...
                className="group bg-white border border-blue-100 shadow-sm hover:shadow-lg transition-all duration-300 p-6 flex flex-col"
              >
                <div className="flex items-start gap-4 mb-3">
                  ...
                  <div>
                    <h3 className="font-bold text-blue-900 text-lg leading-tight group-hover:text-blue-700 transition-colors duration-200">
                      {r.title}
                    </h3>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 max-w-xl mx-auto">
              The {service.shortName.toLowerCase()} questions CT homeowners ask us most. If yours is
              not here, call us. We can usually diagnose it over the phone.
            </p>
          </div>
          ...
          {/* Bottom CTA */}
          <div className="mt-12 text-center bg-blue-50 border border-blue-100 p-8">
            <p className="text-blue-900 font-bold text-lg mb-2">Still stuck?</p>
            <p className="text-slate-500 mb-5">
              A tech can usually diagnose your {service.shortName.toLowerCase()} over the phone. No
              charge.
            </p>
            <a
              href="tel:+19592616736"
      ...
      <section className="py-20 lg:py-28 bg-blue-900" aria-labelledby="final-cta-heading">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-200 text-lg max-w-2xl mx-auto leading-relaxed mb-10">
            Same-day CT service when slots are open. Written estimate before we open anything. OEM
            parts on the truck. 90 days on parts and labor.
          </p>

          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <BookingButton
              appliance={service.applianceValue}
              className="inline-flex items-center justify-center gap-2 font-bold px-8 py-4 transition-all duration-200 cursor-pointer shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 text-gray-900 bg-[#ffb81c] hover:bg-[#e6a619]"
            >
              <svg
                className="w-5 h-5"
                fill="none"
