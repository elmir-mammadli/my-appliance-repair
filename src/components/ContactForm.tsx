      ...
      <section id="contact" className="py-20 lg:py-28 bg-white" aria-labelledby="contact-heading">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
            ...
            <a href="tel:+19592616736" className="text-blue-700 font-bold text-xl hover:text-blue-900 transition-colors duration-200 cursor-pointer">
              Call (959) 261-6736
            </a>
          </div>
          <button
    ...
    <section id="contact" className="py-20 lg:py-28 bg-white" aria-labelledby="contact-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          {/* Left Info */}
          <div>
            <span className="inline-block text-blue-600 font-semibold text-sm tracking-widest uppercase mb-3">Book a Repair</span>
            <h2 id="contact-heading" className="text-3xl sm:text-4xl font-bold text-blue-900 mb-6">
              Schedule Your Repair Today
            </h2>
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              Fill out the form and we&apos;ll contact you within 30 minutes to confirm your appointment. Same-day service available in most Connecticut areas.
            </p>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center gap-4 p-5 bg-blue-50 border border-blue-200 rounded-xl">
                <div className="w-12 h-12 bg-blue-700 rounded-xl flex items-center justify-center text-white flex-shrink-0">
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-xl border bg-white text-blue-900 placeholder-slate-400 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                      errors.name ? 'border-red-400 focus:ring-red-400' : 'border-blue-200 hover:border-blue-300'
                    }`}
                    aria-required="true"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-xl border bg-white text-blue-900 placeholder-slate-400 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                        errors.phone ? 'border-red-400 focus:ring-red-400' : 'border-blue-200 hover:border-blue-300'
                      }`}
                      aria-required="true"
                  ...
                  <div>
                    <label htmlFor="zip" className="block text-sm font-semibold text-blue-900 mb-1.5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-blue-200 hover:border-blue-300 bg-white text-blue-900 placeholder-slate-400 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>

                {/* Appliance */}
                <div>
                  <label htmlFor="appliance" className="block text-sm font-semibold text-blue-900 mb-1.5">
                    Appliance Type <span className="text-red-500" aria-hidden="true">*</span>
                  </label>
                  <select
                    id="appliance"
                    value={form.appliance}
                    onChange={(e) => handleChange('appliance', e.target.value)}
                    className={`w-full px-4 py-3 rounded-xl border bg-white text-blue-900 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer ${
                      errors.appliance ? 'border-red-400 focus:ring-red-400' : 'border-blue-200 hover:border-blue-300'
                  ...
                  {errors.appliance && <p id="appliance-error" className="text-red-500 text-sm mt-1" role="alert">{errors.appliance}</p>}
                </div>

                {/* Brand */}
                <div>
                  <label htmlFor="brand" className="block text-sm font-semibold text-blue-900 mb-1.5">
                ...
                {/* Issue */}
                <div>
                  <label htmlFor="issue" className="block text-sm font-semibold text-blue-900 mb-1.5">
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 rounded-xl border bg-white text-blue-900 placeholder-slate-400 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none ${
                      errors.issue ? 'border-red-400 focus:ring-red-400' : 'border-blue-200 hover:border-blue-300'
                    }`}
                    aria-required="true"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <fieldset>
                      <legend className="block text-sm font-semibold text-blue-900 mb-2">Urgency</legend>
                  ...
                  <div>
                    <label htmlFor="timeSlot" className="block text-sm font-semibold text-blue-900 mb-1.5">Preferred Time</label>
                    <select
                      id="timeSlot"
                      value={form.timeSlot}
                      onChange={(e) => handleChange('timeSlot', e.target.value)}
                      className="w-full px-3 py-2.5 rounded-xl border border-blue-200 hover:border-blue-300 bg-white text-blue-900 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm cursor-pointer"
                    >
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full flex items-center justify-center gap-2 bg-[#ffb81c] hover:bg-[#e6a619] disabled:bg-[#ffb81c]/50 text-gray-900 font-bold py-4 rounded-xl transition-all duration-200 cursor-pointer shadow-md hover:shadow-lg text-lg disabled:cursor-not-allowed"
