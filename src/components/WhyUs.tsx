...
const reasons = [
  ...
  },
  {
    ...
    description:
      "Call before noon and we'll often be there the same day. Evening and weekend appointments available.",
  },
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      'No hidden fees. You get a full written estimate before any work begins. Free diagnostic with repair.',
  },
  {
    icon: (
      <svg
    ...
    description:
      'Our vans carry OEM parts for the most common failures, so most repairs finish in a single visit.',
  },
];
...
function ReasonCard({ reason, index }: { reason: (typeof reasons)[0]; index: number }) {
  ...
  return (
    ...
    >
      <div className="flex-shrink-0 w-14 h-14 bg-blue-700 flex items-center justify-center text-white shadow-md">
        {reason.icon}
      </div>
      <div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600 mb-10 leading-relaxed">
              Connecticut homeowners count on us for quality, transparency, and fast service. That
              commitment has made us the #1 rated appliance repair company in the state.
            </p>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-gradient-to-br from-blue-700 to-blue-900 p-8 text-white shadow-xl">
              ...
              <p className="text-blue-100 text-lg font-medium">
                Perfect rating across Google &amp; Thumbtack
              </p>
            </div>
                ...
                {[
                  {
                    ...
                    desc: 'Tell us about your appliance issue',
                  },
                  {
                    step: '2',
                    title: 'Technician Arrives',
                    desc: 'Same or next day at your convenience',
                  },
                  {
                    step: '3',
                    title: 'Diagnosis & Quote',
                    desc: 'Free written estimate before we start',
                  },
                  {
                    step: '4',
                    title: 'Repair & Warranty',
                    desc: '90-day guarantee on all repairs',
                  },
                ].map((item) => (
                  <div key={item.step} className="flex items-start gap-4">
                    <div className="w-8 h-8 bg-blue-700 text-white flex items-center justify-center text-sm font-bold flex-shrink-0">
                      {item.step}
                    </div>
                    <div>
