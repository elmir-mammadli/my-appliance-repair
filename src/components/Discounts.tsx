...
const discounts = [
  {
    ...
    badge: '$30 OFF',
    description:
      'Active duty, reservists, National Guard, veterans, and surviving spouses of U.S. service members.',
  ...
  },
  {
    ...
    badge: '$30 OFF',
    description:
      'Full-time police officers, firefighters, EMTs, paramedics, and 911 emergency dispatchers.',
  ...
  },
  {
    ...
    badge: '$30 OFF',
    description:
      'Connecticut residents aged 65 and older. Fixed income or not — every senior deserves a break.',
  ...
  },
  {
    ...
    badge: '$30 OFF',
    description:
      'K–12 teachers, college faculty, school administrators, and licensed childcare workers.',
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <span
          className={`${item.accentColor} text-sm font-extrabold px-3 py-1.5 tracking-wide flex-shrink-0`}
        >
          {item.badge}
        </span>
      </div>
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-blue-400 text-xs mt-6 leading-relaxed">
          Discounts apply to labor charges only and cannot be combined with other offers or
          promotions. One discount per service call. Verification required at time of service.
        </p>
      </div>
    </section>
  );
