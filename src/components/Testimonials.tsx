  ...
  return (
    <section id="testimonials" className="bg-blue-50 py-14" aria-labelledby="testimonials-heading">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 flex flex-col gap-6 border border-blue-100 bg-white p-6 shadow-sm lg:flex-row lg:items-center lg:justify-between">
          <div>
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {testimonials.map((testimonial) => (
            <article
              ...
              className="flex h-full flex-col border border-blue-100 bg-white p-6 shadow-sm"
            >
              <div className="flex items-center gap-3">
                <div className="flex h-11 w-11 items-center justify-center bg-blue-700 text-sm font-bold text-white">
