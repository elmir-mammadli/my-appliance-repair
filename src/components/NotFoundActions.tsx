  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
      ...
      <button
        ...
        className="inline-flex items-center gap-2 border-2 border-blue-900 text-blue-900 hover:bg-blue-900 hover:text-white font-semibold px-8 py-3.5 transition-colors duration-200 text-base"
      >
        <svg
          className="w-5 h-5"
          fill="none"
