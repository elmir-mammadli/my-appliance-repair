    ...
    >
      ...
      <div className="px-5 pb-5 space-y-2">
        ...
        <button
          ...
          className="block w-full text-center border-2 border-blue-200 hover:border-blue-400 text-blue-900 font-bold py-2.5 rounded-xl transition-all duration-200 cursor-pointer text-sm"
        >
          Book This Repair
        </button>
      </div>
