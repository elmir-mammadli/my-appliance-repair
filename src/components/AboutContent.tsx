      ...
      <section className="bg-blue-950 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16 lg:pt-36 lg:pb-24">
          ...
          <nav
            ...
            className="flex items-center gap-2 text-xs text-blue-400 mb-6"
          >
        ...
        >
          ...
          <div>
            ...
            <div className="space-y-4 text-slate-600 leading-relaxed">
              <p>
                MyAppliance Repair LLC was founded by a Connecticut-born technician with over a
                decade of experience working for a major national appliance chain. After years of
                watching customers get hit with surprise fees, week-long wait times, and technicians
                who&apos;d never return a call &mdash; he knew there had to be a better way.
              </p>
              <p>
                He launched MyAppliance Repair LLC with one simple promise: show up when we say we
                will, fix it right the first time, and charge a fair price. No bait-and-switch
                diagnostics. No pressure to replace an appliance that can still be saved. Just
                honest, skilled work backed by a real warranty.
              </p>
              <p>
          ...
          <div className="relative">
            ...
            <div
              className="absolute -top-5 -right-5 w-28 h-28 bg-[#ffb81c]/15 blur-2xl pointer-events-none"
              aria-hidden="true"
            />
            <div
              className="absolute -bottom-5 -left-5 w-36 h-36 bg-blue-300/20 blur-2xl pointer-events-none"
              aria-hidden="true"
            />
          </div>
        </div>
      ...
      <section className="bg-blue-950 py-14">
        ...
        >
          {STATS.map((stat, i) => (
            ...
            >
              <p className="text-3xl sm:text-4xl font-extrabold text-[#ffb81c] mb-1">
                {stat.value}
              </p>
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 mt-4 max-w-xl mx-auto leading-relaxed">
              We&apos;re not just skilled at what we do — we hold the certifications to prove it.
              Every credential represents a real commitment to quality, safety, and accountability.
            </p>
          </div>
