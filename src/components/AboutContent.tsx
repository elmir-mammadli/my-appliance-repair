      ...
      <section className="bg-white py-20 lg:py-28">
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="absolute -top-5 -right-5 w-28 h-28 bg-[#ffb81c]/15 rounded-full blur-2xl pointer-events-none" aria-hidden="true" />
            <div className="absolute -bottom-5 -left-5 w-36 h-36 bg-blue-300/20 rounded-full blur-2xl pointer-events-none" aria-hidden="true" />
          </div>
        </div>
      </section>
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {WHY_VALUES.map((v, i) => (
              <div
                key={v.title}
                className={`bg-white rounded-2xl p-7 shadow-sm border border-blue-100 flex gap-5 transition-all duration-500 ${
                  valuesSection.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
                }`}
                style={{ transitionDelay: `${i * 100 + 100}ms` }}
              >
                <div className="w-12 h-12 bg-blue-700 rounded-xl flex items-center justify-center flex-shrink-0 text-white">
                  {v.icon}
                </div>
                <div>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {CREDENTIALS.map((cred, i) => (
              <div
                key={cred.label}
                className={`flex items-center gap-3 bg-blue-50 border border-blue-200 rounded-xl px-5 py-4 transition-all duration-500 ${
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-10">
            {CT_CITIES.map((city) => (
              <span
                key={city}
                className="inline-flex items-center gap-1.5 bg-white border border-blue-200 text-blue-800 text-sm font-medium px-4 py-2 rounded-full"
              >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#ffb81c] hover:bg-[#e6a619] text-gray-900 font-bold px-8 py-4 rounded-xl transition-colors duration-200 cursor-pointer shadow-lg text-base"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
