...
export default function BookingModal() {
 ...
 <div className={`w-2 h-2 transition-colors duration-300 ${step === 2 ?'bg-blue-600' :'bg-slate-200'}`} />
 </div>
)}
 <button
 onClick={closeModal}
 ...
 <span className="w-5 h-5 bg-blue-100 text-blue-700 text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">1</span>
 <span>You&apos;ll get a call at <strong className="text-blue-950">{form.phone}</strong> within 30 minutes to confirm.</span>
 </li>
 <li className="flex items-start gap-2.5">
 <span className="w-5 h-5 bg-blue-100 text-blue-700 text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">2</span>
 <span>Your technician arrives in your preferred window{form.date ? <> on <strong className="text-blue-950">{form.date}</strong></> :''}.</span>
 </li>
 <li className="flex items-start gap-2.5">
 <span className="w-5 h-5 bg-blue-100 text-blue-700 text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">3</span>
...
'90-day parts & labor warranty',
 ...
 className="w-full flex items-center justify-center gap-2 bg-[#ffb81c] hover:bg-[#e6a619] disabled:bg-[#ffb81c]/50 text-gray-900 font-bold py-4 transition-colors cursor-pointer shadow-md text-lg disabled:cursor-not-allowed"
