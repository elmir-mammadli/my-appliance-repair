            ...
            <form onSubmit={handleStep1Next} noValidate aria-label="Step 1: Contact check">
              <div className="space-y-5">
                ...
                <div>
                  ...
                  />
                  {errors.phone && (
                    <p id="m-phone-error" className="text-red-500 text-xs mt-1" role="alert">
                      {errors.phone}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    aria-required="true"
                    aria-describedby={errors.zip ? 'm-zip-error' : 'm-zip-status'}
                  />
                  {errors.zip ? (
                    <p id="m-zip-error" className="text-red-500 text-xs mt-1" role="alert">
                      {errors.zip}
                    </p>
                  ) : (
                    form.zip.length === 5 &&
              ...
              <form onSubmit={handleSubmit} noValidate aria-label="Step 2: Repair details">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    />
                    {errors.name && (
                      <p id="m-name-error" className="text-red-500 text-xs mt-1" role="alert">
                        {errors.name}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        aria-required="true"
                        aria-describedby={errors.appliance ? 'm-appliance-error' : undefined}
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      aria-required="true"
                      aria-describedby={errors.issue ? 'm-issue-error' : undefined}
                    />
                    {errors.issue && (
                      <p id="m-issue-error" className="text-red-500 text-xs mt-1" role="alert">
                        {errors.issue}
                      </p>
                    )}
                  </div>
