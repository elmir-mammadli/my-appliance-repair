      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            ...
            oven repair, and more. Pick an appliance to see the symptoms we hear most weeks and the
            parts we keep on the truck.
          </p>

          {/* Review pill */}
          <div className="inline-flex items-center gap-2 mt-5 bg-white border border-blue-200 px-5 py-2 shadow-sm">
        ...
        <div className="mt-12 text-center">
          <Link
            href="/services"
            className="inline-flex items-center gap-2 border-2 border-blue-900 hover:bg-blue-900 hover:text-white text-blue-900 font-bold px-8 py-3.5 transition-all duration-200 cursor-pointer"
          >
            View All Services
            <svg
              className="w-4 h-4"
          ...
          {[
            {
              ...
              sub: 'Original manufacturer parts on every repair',
            },
            {
              icon: ShieldPlusIcon,
              label: '90-day warranty',
              sub: 'Parts and labor guaranteed for 90 days',
            },
            {
              icon: FlashIcon,
