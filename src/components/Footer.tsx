...
function ArrowLink({ href, label, external = false }: { href: string; label: string; external?: boolean }) {
  const cls =
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-3">
                <svg className="w-4 h-4 text-[#F97316] flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mb-5">
              Love our service? Share your experience and help Connecticut neighbors find trusted appliance repair.
            </p>
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 ring-1 ring-white/15 hover:bg-white/20 transition-colors duration-200"
              >
              ...
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 ring-1 ring-white/15 hover:bg-white/20 transition-colors duration-200 overflow-hidden"
              >
