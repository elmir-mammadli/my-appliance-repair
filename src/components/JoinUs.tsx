      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-14">
          {perks.map((perk) => (
            <div
              key={perk.title}
              className="bg-blue-900/50 border border-blue-800 rounded-2xl p-6 hover:bg-blue-900/80 hover:border-blue-700 transition-all duration-300"
            >
              <div className="w-12 h-12 bg-[#ffb81c]/10 rounded-xl flex items-center justify-center text-[#ffb81c] mb-4">
                {perk.icon}
              </div>
        ...
        <div className="text-center">
          <button
            ...
            className="inline-flex items-center gap-2 bg-[#ffb81c] hover:bg-[#e6a619] text-gray-900 font-bold px-8 py-4 rounded-xl transition-colors duration-200 cursor-pointer shadow-lg text-lg"
          >
