    ...
    <div ref={wrapperRef} className="relative">
      <div className="relative">
        <input
          ...
          className={`w-full px-4 py-3 rounded-xl border bg-white text-blue-950 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200 ${
